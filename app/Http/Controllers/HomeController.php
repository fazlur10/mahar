...
class HomeController extends Controller
{
    ...
    public function member_listing(Request $request)
    {
      ...
      if($matital_status != null){
        ...
        return view('frontend.member.member_listing.index', compact('users','age_from','age_to','matital_status','religion_id','caste_id','sub_caste_id','mother_tongue_id','profession','country_id','state_id','city_id','min_height','max_height','member_type'));
    }
